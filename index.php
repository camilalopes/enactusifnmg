		...
		<div class="container">
			<div id="home-row-1" class="row clearfix">
				<div class="col-12">
					...
					<h1><img src="images/logob.png" alt="Enactus IFNMG"></h1><br>
					<h4 class="font-thin">Empreendedorismo, <span class="font-semibold">Ação </span>e coletividade!.</h4>
					<br>
					<br>
				</div><!-- /col-12 -->
			</div><!-- /row -->
